...
class AutoInfoClass(object):
    ...
    # @tuando: this _derive function will get and save info of known class and return new class
    # @tuando: info is the info 'or attr' of that class was saved to pass to newclass
    # @tuando: otherbases is the info 'or attr' of parent will be updated to the information of class
    @classmethod
    def _derive(cls, name, info, otherbases, recurse=False):
        ...
        for obase in otherbases:
            # @tuando: tuple/dict because otherbases save the 'params' attribute and params sometimes is class of indicators
