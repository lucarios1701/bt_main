...
class MetaAnalyzer(bt.MetaParams):
    ...
    def dopostinit(cls, _obj, *args, **kwargs):
        ...
        # Analyze
        # @tuando - This register from parent will add class instance of Anazlyzer
        # @tuando - to _children, (e.g when initiating Pyfolio, findowner will see
        # @tuando - instance of Return, transactions, etc. - the after second level
        # @tuando - of this _obj, then will add to _children)
        # @tuando - after add to _children, the _next() of analyzer was call from
        # @tuando - _oncepost  of Strategy and it calls the _next() of analyzer which
        # @tuando - will call the _next of _children and save data to analyzer
